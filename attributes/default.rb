...
default['splunk']['forwarder'] = {
  'url' => value_for_platform_family(
    %w(rhel fedora suse amazon) => "https://download.splunk.com/products/universalforwarder/releases/9.4.0/linux/splunkforwarder-9.4.0-6b4ebe426ca6-linux-2.6-#{splunk_arch_rpm}.rpm",
    'debian' => "https://download.splunk.com/products/universalforwarder/releases/9.4.0/linux/splunkforwarder-9.4.0-6b4ebe426ca6-linux-#{splunk_arch}.deb"
  ),
  'version' => '9.4.0',
}
...
default['splunk']['server'] = {
  'runasroot' => true,
  'url' => value_for_platform_family(
    %w(rhel fedora suse amazon) => "https://download.splunk.com/products/splunk/releases/9.4.0/linux/splunk-9.4.0-6b4ebe426ca6-linux-2.6-#{splunk_arch_rpm}.rpm",
    'debian' => "https://download.splunk.com/products/splunk/releases/9.4.0/linux/splunk-9.4.0-6b4ebe426ca6-linux-#{splunk_arch}.deb"
  ),
  'version' => '9.4.0',
}
